...
public class BottomRightAnchorTouchListener implements View.OnTouchListener {
    private int _xDelta;
    private int _yDelta;
    ...
    public BottomRightAnchorTouchListener(View viewToResize, TextView lblStatus/*, Anchor.ResizeMode resizeMode*/) {
