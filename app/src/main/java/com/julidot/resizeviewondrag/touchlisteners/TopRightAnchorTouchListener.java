...
public class TopRightAnchorTouchListener implements View.OnTouchListener {
    private int _xDelta;
    private int _yDelta;
    ...
    public TopRightAnchorTouchListener(View viewToResize, TextView lblStatus/*, Anchor.ResizeMode resizeMode*/) {
